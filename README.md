...
> [!TIP]
All official diagrams are provided in the product documentation found on the  [Broadcom Technical Documentation Portal](https://techdocs.broadcom.com).
...
1. Open the template file in Microsoft Visio.
2. Load the stencils.
